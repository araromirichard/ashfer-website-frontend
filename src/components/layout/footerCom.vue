<template>
  <footer class="bg-secondary w-full py-6">
    <div class="container mx-auto flex text-white mt-10 md:mt-20 flex-wrap w-full md:space-x-3 space-y-8">
      <div class="flex flex-col justify-start content-center md:hidden">
        <img src="/src/assets/footerlogo.svg" class="w-60" alt="" />
        <span class="text-base font-poppins font-bold ml-10">Empowering Nations</span>
      </div>
      <div class="flex flex-wrap my-4 sm:my-6 md:my-0">
        <div class="font-poppins col-span-12 mx-10 my-8 md:my-0">
          <span
            class="text-base font-poppins uppercase font-medium mb-4 border-b-2 border-primary tracking-buttonWide justify-center">menu</span>
        ...
        <div class="font-poppins mx-10 my-8 md:my-0">
          <span
            class="text-base font-poppins uppercase font-medium mb-4 border-b-2 border-primary tracking-buttonWide justify-center">services</span>
        ...
        <div class="font-poppins mx-10 my-8 md:my-0">
          <span
            class="text-base font-poppins uppercase font-medium mb-4 border-b-2 border-primary tracking-buttonWide justify-center">contact
            us</span>
          ...
          <ul>
            ...
            <li class="links text-sm flex">
              ...
              <a class="phone px-2 md:px-4" href="tel:+233302799601">+233 30 279 9601</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="font-poppins mx-10 md:mx-0 my-8 md:my-0">
        <span
          class="text-base font-poppins uppercase font-medium mb-4 border-b-2 border-primary tracking-buttonWide justify-center">follow
          us</span>

        <ul class="flex flex-row space-x-10">
          <li class="mt-8">
            <a href="#">
              <svg class="w-5 h-5 text-white hover:text-red-400 fill-current" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24">
                <path
          ...
          <li class="mt-8">
            <a href="#">
              <svg viewBox="0 0 512 512 " class="w-6 h-6 text-white hover:text-red-400 fill-current">
                <g>
                  <path
    ...
    <div class="w-full text-white flex justify-center content-center my-20 md:my-24">
      &copy; {{ currentYear }} Ashfar. All right reserved.
    </div>
  </footer>
</template>
