    ...
    >
      ...
      <div class="flex flex-wrap my-4 sm:my-6 md:my-0">
        ...
        <div class="font-poppins mx-10 my-8 md:my-0">
          ...
          <ul>
            <li class="links">
              <router-link to="/">Power</router-link>
            </li>
            <li class="links">
              <router-link to="/about-us">Oil & Gas</router-link>
            </li>
            <li class="links">
              <router-link to="/our-business">Haulage</router-link>
            </li>
            <li class="links">
              <router-link to="/">Manufacturing</router-link>
            </li>
            <li class="links">
              <router-link to="/contact">Construction</router-link>
            </li>
          </ul>
        </div>
        <div class="font-poppins mx-10 my-8 md:my-0">
          ...
          <ul>
            <li class="links text-xs md:text-sm flex">
              <svg
