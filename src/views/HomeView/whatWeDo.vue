<template>
  <div class="w-full h-full justify-center md:justify-start bg-secondary">
    <div class="flex flex-row container mx-auto h-full">
      <div class="flex flex-col justify-center content-start px-8 md:w-3/5 text-left">
        ...
        <div class="sub__title-one font-poppins font-bold pt-4 text-ashfarWhite text-left">
          We offer services in
          <span class="text-orange">Power, Oil and Gas, Haulage, Construction</span>
  ...
  <div
    ...
    <a href="http://ashfarpower.com/" target="_blank">

      <ServicesCard data-aos="fade-up" data-aos-duration="500" cardName="power" src="/images/POWER.jpg" />
    </a>

    <router-link :to="{ name: 'our-business', hash: '#oil' }">
      <ServicesCard data-aos="fade-up" data-aos-duration="500" data-aos-delay="300" cardName="Oil and gas"
        src="/images/OIL-AND-GAS.jpg" />
    </router-link>
    <router-link :to="{ name: 'our-business', hash: '#haulage' }">
      <ServicesCard data-aos="fade-up" data-aos-duration="500" data-aos-delay="350" cardName="haulage"
        src="/images/HAULAGE.jpg" />
    </router-link>
    <router-link :to="{ name: 'our-business', hash: '#construct' }">
      <ServicesCard data-aos="fade-up" data-aos-duration="500" data-aos-delay="400" cardName="construction"
        src="/images/OUR-BUSINESS.jpg" />
    </router-link>
    <a href="https://www.montwater.com" target="_blank">
      <ServicesCard data-aos="fade-up" data-aos-duration="500" data-aos-delay="450" cardName="manufacturing"
